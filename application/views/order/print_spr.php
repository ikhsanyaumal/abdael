<?php
	...
	class PDF extends FPDF
	{
		...
		{			
			...
			$this->Cell(190,5,'SURAT PEMESANAN PEMBELIAN TANAH & BANGUNAN '.$ruko,0,1,'C');
			...
			$this->Cell(10,5,'Atas pemesanan pembelian tersebut, kami menyetujui dan mengikatkan diri kepada ',0,1,'L');		
			...
			$this->Cell(70,5,'Perincian',1,0,'C');
			$this->Cell(50,5,'Nominal',1,0,'C');
			$this->Cell(60,5,'Dibayar Tanggal',1,1,'C');
			...
			$this->Cell(80,5,'Harga Transaksi Sudah Termasuk :',0,0,'L');
			$this->Cell(85,5,'Harga Transaksi Tidak Termasuk :',0,1,'L');

			$this->SetFont('Arial','',9);
			$this->Cell(80,4,'a. PPN 10%',0,0,'L');
			$this->Cell(3,4,'a. ',0,0,'L');
			$this->Cell(85,4,'Biaya Notaris : Biaya AJB, BN, Checking, PNBP (Sesuai tagihan notaris)',0,1,'L');
			
			$this->Cell(80,4,'b. IMB (Ijin Mendirikan Bangunan)',0,0,'L');
			$this->Cell(3,4,'b. ',0,0,'L');
			$this->Cell(85,4,'BPHTB & biaya lain terkait dengan Fasilitas Kredit Bank',0,1,'L');
			
			$this->Cell(80,4,'c. Infrastruktur Listrik',0,0,'L');
			$this->Cell(3,4,'c. ',0,0,'L');
			$this->Cell(85,4,'PBB setelah transaksi',0,1,'L');
			
			$this->Cell(80,4,'d. Infrastruktur Air Bersih',0,0,'L');
			$this->Cell(3,4,'d. ',0,0,'L');
			$this->Cell(85,4,'Asuransi kebakaran selama masa angsuran',0,1,'L');
			
			$this->Cell(80,4,'',0,0,'L');
			$this->Cell(3,4,'e. ',0,0,'L');
			$this->Cell(85,4,'Biaya perjanjian pinjam pakai',0,1,'L');
			
			$this->Cell(80,4,'',0,0,'L');
			$this->Cell(3,4,'f. ',0,0,'L');
			$this->Cell(85,4,'Penambahan daya listrik, pemeliharaan Fiber Optic',0,1,'L');
			
			$this->Cell(80,4,'',0,0,'L');
			$this->Cell(3,4,'g. ',0,0,'L');
			$this->Cell(85,4,'Biaya maintenance yang akan ditentukan dikemudian hari, terhitung',0,1,'L');

			$this->Cell(80,4,'',0,0,'L');
			$this->Cell(3,4,'',0,0,'L');
			$this->Cell(85,4,'sejak Serah Terima Tanah dan Bangunan',0,1,'L');
			
			$this->Cell(80,4,'',0,0,'L');
			$this->Cell(3,4,'h. ',0,0,'L');
			$this->Cell(85,4,'Pajak dan biaya - biaya lainnya yang kelak dikemudian hari ditentukan',0,1,'L');

			$this->Cell(80,4,'',0,0,'L');
			$this->Cell(3,4,'',0,0,'L');
			$this->Cell(85,4,'oleh pemerintah serta berlaku surut adalah tanggung jawab pembeli',0,1,'L');
			
			$this->Ln();
			$this->SetFont('Arial','',11.5);
			$this->Cell(7,5,'3. ',0,0,'L');
			$this->Cell(10,5,'Sehubungan  dengan  pemesanan  unit  tersebut  diatas,  maka  yang  bertandatangan  dibawah  ini ',0,1,'L');
			$this->Cell(7,5,'',0,0,'L');
			$this->Cell(10,5,'menyatakan setuju dan mengikat diri atas syarat - syarat dan ketentuan - ketentuan mengenai Surat ',0,1,'L');
			$this->Cell(7,5,'',0,0,'L');
			$this->Cell(10,5,'Pemesanan Pembelian Tanah dan Bangunan sebagaimana tercantum di balik halaman ini.',0,1,'L');					
